                            ...
                            <table>
                              <tr>
                                <th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <th class="small-12 large-12 columns first last">
                                                    <table class="callout">
                                                      <tr>
                                                          <th class="callout-inner lightpink">
                                                                      ...
                                                                      <tbody>
                                                                          <tr>                                                                                
                                                                              <td class="float-center">
                                                                                  <a href="{{ $data['urlApprove'] }}" class="button" style="background-color: #3adb76; color: black; padding: 5px 15px;" >{{__('orgmgmt')['mails']['btn']['accept']}}</a>
                                                                                  <a href="{{$data['urlReject']}}" class="button" style="background-color:#ec5840; color: black; margin-left: 10px;padding: 5px 15px;">{{__('orgmgmt')['mails']['btn']['reject']}}</a>
                                                                              </td>                                                                             
                                                                          </tr>
                                                                      </tbody>
                                                                  </table>
                                    ...
                                    <p>{!! str_replace('<<Organization Name>>', $data['organization_name'], __('orgmgmt')['mails']['invite_footer']) !!}</p>
                                </th>
                                <th class="expander"></th>
                              </tr>
                            </table>
