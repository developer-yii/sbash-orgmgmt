...
<html lang="en">
  <head>
    <title>Invitation to Join {{ $data['organization_name'] }}</title>
    <meta charset="utf-8">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-sm-12 m-auto">
                ...
                <p>You are invited to Join {{ $data['organization_name'] }} by {{ $data['user_name'] }}.</p>

                <p>Click below button to Join</p>                
                
                <h3><a class="btn btn-primary" href="{{ $data['url'] }}">Join</a></h3>
            </div>
        </div>
    </div>
  </body>
