...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>{{ __('orgmgmt')['mails']['invite_response_title']}}</title>    
    <style>
      .wrapper {
        width: 100%;
      }
                            ...
                            <table>
                              <tr>
                                <th>
                                    ...
                                    <p>{{str_replace('<<invitee name>>', $data['user_name'], __('orgmgmt')['mails']['invite_response_salutation'])}}</p>
                                    
                                    <p>{{$data['msgblock1']}}</p>                                    
                                                                                              
                                    <p>{!! str_replace('<<Organization name>>', $data['organization_name'], __('orgmgmt')['mails']['invite_response_footer'])!!}</p>
                                </th>
